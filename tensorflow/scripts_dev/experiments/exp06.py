...
The synthetic gradients model DOES NOT take into account the state of the layer at the same level.
"""
...
class Flags:
    def __init__(self):
        ...
        self.summaries_dir = "./exp06/tensorboard"
...
with tf.device("/gpu:0"):
    ...
    with tf.Graph().as_default():
        ...
        with tf.name_scope('synthetic_gradients'):
            ...
            batch_dimension = synthetic_gradients_model_input_and_labels_shape[0]
            
            synthetic_gradients_model_input = input_and_labels
        ...
        with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
            ...
            def train_step(print_out=False, learning_rate=FLAGS.learning_rate, step=0):
                ...
                """
                # Hidden 2&3 forward with gradient (w.r.t. layer2_input) computation
                layer2_real_gradient = sess.run(hidden2_true_gradients, feed_dict={
                    layer2_input: layer1_output, 
                    labels_placeholder: labels_feed
                })
